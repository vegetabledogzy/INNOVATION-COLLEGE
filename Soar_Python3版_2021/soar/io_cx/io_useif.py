#
# soar
# io_cx.py - object-oriented interface to the robot
#

# This io_cx file makes use of the "official" soar interface
...
# the io_cx.py file.  However it seems to introduce some kind of lag that
...
sys.path.append("C:\\Users\\Administrator\\AppData\\Local\\Programs\\Python\\Python36-32\\Lib\\site-packages\\lib601")
...
def configure_io(namespace):
    ...
    # the brain environ by setting it to None when io_cx.py is imported
    global io_environ
