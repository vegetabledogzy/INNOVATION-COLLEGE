...
##in Python 3 there is no need for that.lzy gai
##try:
##    True
##except:
##   True = 1
...
class SerialException(Exception):
    """Base class for serials port related exceptions."""
...
class FileLike(object):
    ...
    Note that when the serials port was opened with _NO_ timeout that
